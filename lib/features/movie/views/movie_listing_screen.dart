...
import 'package:golidoli_app/features/movie/controllers/movie_listing_controller.dart';
...
class MovieListingScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final controller = Get.put(MovieListingController());
    return Scaffold(
  ...
  Widget _buildCategoryTabs(MovieListingController controller) {
    return SizedBox(
      height: 36,
      child: Obx(() {
  ...
  Widget _buildGrid(MovieListingController controller) {
    return Obx(() {
      ...
      return GridView.builder(
        ...
        itemBuilder: (_, i) => _buildCard(movies[i], controller),
      );
    });
  }
  ...
  Widget _buildCard(
    ...
    MovieListingController controller,
  ) {
    return GestureDetector(
